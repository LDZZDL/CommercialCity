...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/customerfindpassword.css">
<script src="${pageContext.request.contextPath}/script/jquery-3.2.1.js"></script>
<script src="${pageContext.request.contextPath}/script/customerfindpassword3.js"></script>
</head>
<body>
	<h2>重置密码</h2>
<div id="background">
  <div id="content">
    ...
    <form action="/CommercialCity/customerFindPassword?action=submit" method="post">
      <div class="kind">
