...
public class Page {
	...
	public Page(int pageNo, int pageSize, long totalProductNumber, long totalPageNo, String searchValue,
			String orderType, Double priceRangeLeft, Double priceRangeRight) {
		super();
		this.pageNo = pageNo;
		this.pageSize = pageSize;
		this.totalProductNumber = totalProductNumber;
	...
	public String toString() {
		return "Page [pageNo=" + pageNo + ", pageSize=" + pageSize + ", totalProductNumber=" + totalProductNumber
				+ ", totalPageNo=" + totalPageNo + ", searchValue=" + searchValue + ", orderType=" + orderType
				+ ", priceRangeLeft=" + priceRangeLeft + ", priceRangeRight=" + priceRangeRight + "]";
	}
