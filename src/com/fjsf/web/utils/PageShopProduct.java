...
public class PageShopProduct {
	...
	public PageShopProduct() {
		super();
		// TODO Auto-generated constructor stub
	}

	public PageShopProduct(int pageNo, int pageSize, long totalProductNumber, long totalPageNo, String searchValue,
	...
	public String toString() {
		return "PageShopProduct [pageNo=" + pageNo + ", pageSize=" + pageSize + ", totalProductNumber="
